...
output_path = '/home/tommy/Project/PcodeBERT/outputs/models/cbow/'
...
model.wv.save(output_path + 'cbow_vectors.kv')

print(f"CBOW model trained and saved to {output_path}")
