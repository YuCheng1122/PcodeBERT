...
output_path = '/home/tommy/Project/PcodeBERT/outputs/models/skipgram/'
...
model.save(output_path + 'skipgram_model.model')
model.wv.save(output_path + 'skipgram_vectors.kv')
